...
handleRegisterSubmit = () => {
  ...
  console.log('send email: ', email, password);
    ...
    <div className="login-content">
      <div >
        ...
        <h2 className="title">Buat Akun Baru</h2>
            ...
            <a className="nav-link" href="/login"  style={{color: "black"}} >Kamu sudah punya akun ? <span >Masuk disini</span>  </a>
            </div>
            </div>
        </div>
    </div>
  ...
  const reduxDispatch = (dispath) => ({
    registerAPI: (data) => dispath(registerUserAPI(data))
  }) 
